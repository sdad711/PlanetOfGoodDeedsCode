...
using UnityEngine;
using Spine.Unity;
public class TeamGlass : MonoBehaviour
{
    ...
    public static TeamGlass Instance { get; private set; }
    private void Awake()
    {
        Instance = this;
    }
    ...
    private void CollectGlassAudio()
    {
        string[] digSounds = new string[] { "staklo1", "staklo2", "staklo3" };
