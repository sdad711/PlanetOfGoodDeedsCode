...
public class TeamPaper : MonoBehaviour
{
    ...
    public static TeamPaper Instance { get; private set; }
    private void Awake()
    {
        Instance = this;
    }
    ...
    private void CollectPaperAudio()
    {
        string[] digSounds = new string[] { "papir1", "papir2", "papir3" };
